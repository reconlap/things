...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 256=full current , default 255
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {81.307214287,80.232104092,1496.227184664*8/3,760*1.1}  // default steps per unit for ultimaker
